...
err_0004 = pd.read_csv("../build/data/err_4000.txt",   names=["t", "e_rk", "e_fe"], sep=" ")
err_0008 = pd.read_csv("../build/data/err_8000.txt",   names=["t", "e_rk", "e_fe"], sep=" ")
err_0016 = pd.read_csv("../build/data/err_16000.txt",  names=["t", "e_rk", "e_fe"], sep=" ")
err_0032 = pd.read_csv("../build/data/err_32000.txt",  names=["t", "e_rk", "e_fe"], sep=" ")
err_0064 = pd.read_csv("../build/data/err_64000.txt",  names=["t", "e_rk", "e_fe"], sep=" ")
#err_0128 = pd.read_csv("../build/data/err_128000.txt", names=["t", "e_rk", "e_fe"], sep=" ")
#err_0256 = pd.read_csv("../build/data/err_256000.txt", names=["t", "e_rk", "e_fe"], sep=" ")
#err_1024 = pd.read_csv("../build/data/err_1024000.txt", names=["t", "e_rk", "e_fe"], sep=" ")
...
plt.ylabel("$\epsilon$")
plt.legend(loc='best')
plt.savefig("../build/plots/err_rk4.pdf") if save_fig else plt.show()
...
#plt.ylabel("$\epsilon$")
#plt.legend(loc='best')
#plt.savefig("../build/plots/err_rk4_more.pdf") if save_fig else plt.show()
...
plt.ylabel("$\epsilon$")
plt.legend(loc='best')
plt.savefig("../build/plots/err_fe.pdf") if save_fig else plt.show()
...
#plt.ylabel("$\epsilon$")
#plt.legend(loc='best')
#plt.savefig("../build/plots/err_fe_more.pdf") if save_fig else plt.show()
...
plt.ylabel("$\epsilon$")
plt.legend(loc='best')
plt.savefig("../build/plots/err_rk4_fe.pdf") if save_fig else plt.show()
